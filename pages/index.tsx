			...
			<div className="flex flex-col gap-10 md:gap-20 px-5 md:px-20 py-10 md:py-20">
				<div className="  flex flex-col gap-8 text-center max-w-[755px] self-center">
					...
					<div className="flex justify-center gap-2 md:gap-6 self-center">
						<Button
							className="text-sm  flex justify-center items-center bg-abeg-primary font-semibold text-white md:text-base outline-none whitespace-nowrap px-3 md:px-4"
							asChild
						>
							<Link href="/c/create">Start fundraiser</Link>
						</Button>
						<Button
							className="text-sm flex justify-center items-center border border-abeg-primary font-semibold text-abeg-primary md:text-base outline-none whitespace-nowrap px-3 md:px-4"
							asChild
						>
...
const WhyUs = () => {
	...
	return (
		<div className="flex flex-col gap-8 md:gap-12">
			...
			<Button
				asChild
				className="text-sm  self-center bg-abeg-primary font-semibold text-white md:text-base outline-none whitespace-nowrap px-3 md:px-4 "
			>
