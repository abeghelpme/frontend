			...
			<div className="flex flex-col gap-10 md:gap-20 px-5 md:px-20 py-10 md:py-20">
				<div className="  flex flex-col gap-8 text-center max-w-[755px] self-center">
					<div className="relative">
						<p className=" text-4xl  md:text-5xl font-extrabold leading-loose">
					...
					<p className=" text-xl md:text-2xl font-normal leading-loose">
				...
				<div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4  gap-8 md:gap-6  items-center">
					...
					<div className="flex flex-col-reverse md:flex-col gap-4 text-white overflow-hidden">
						...
						<div className="relative flex flex-col gap-8 p-4 md:p-6 bg-abeg-primary rounded-lg overflow-hidden ">
							...
							<p className="font-medium text-base md:text-lg">
								30% of the African population lacks access to safe drinking
								water, and about 70% does not have access to basic sanitation
								facilities.
							</p>
						</div>
					</div>
					<div className="flex flex-col gap-4 text-white ">
						<div className=" flex flex-col gap-20 p-4 md:p-6 bg-abeg-primary overflow-hidden rounded-lg">
							...
							<p className="font-medium text-base md:text-lg">
								Empower others to thrive, fostering a better world for all.
								Let's create a community where everyone flourishes and
...
const BringPositiveChange = () => {
	const positiveChangesMade = [
		{
			percentage: 95,
			text: `With a 95% success rate, our campaigns often exceed their fundraising goals, turning dreams into reality.`,
		},
		{
			percentage: 40,
			text: `40% of our donors have supported more than one campaign, highlighting the trust and commitment of our community.`,
		},
		{
			percentage: 99.9,
			text: `Maintaining a 99.9% uptime, our platform ensures that your campaign is always accessible to potential donors.`,
		},
	];
	return (
		<div className="flex flex-col gap-16 lg:px-10">
			...
			<div className="flex flex-col md:flex-row gap-6">
				{positiveChangesMade.map((change, id) => {
					return (
						<div className="flex flex-col gap-4 text-justify">
							<p className="text-3xl md:text-4xl font-bold text-abeg-primary">
								{change.percentage}%
							</p>
							<p className="text-lg md:text-xl font-normal">{change.text}</p>
						</div>
					);
				})}
			</div>
