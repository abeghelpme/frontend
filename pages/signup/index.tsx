      ...
      >
        ...
        <div className="space-y-3 sm:grid sm:grid-cols-2 sm:gap-4 sm:space-y-0">
          <div className="space-y-1">
            ...
            />
            {errors.firstName && (
              <p className="mt-2 text-sm text-abeg-teal">{errors.firstName.message}</p>
            )}
          </div>
          <div className="space-y-1">
            ...
            />
            {errors.lastName && (
              <p className="mt-2 text-sm text-abeg-teal">{errors.lastName.message}</p>
            )}
          </div>
        </div>
        ...
        <div className="space-y-1">
          ...
          />
          {errors.email && (
            <p className="mt-2 text-sm text-abeg-teal">{errors.email.message}</p>
          )}
        </div>
        ...
        <div className="space-y-3 sm:grid sm:grid-cols-2 sm:gap-5 sm:space-y-0">
          <div className="space-y-1">
            ...
            {errors.password && (
              <p className="mt-2 text-sm text-abeg-teal">{errors.password.message}</p>
            )}
          </div>
          <div className="space-y-1">
            ...
            {errors.confirmPassword && (
              <p className="text-sm text-abeg-teal">{errors.confirmPassword.message}</p>
            )}
          </div>
        </div>
        <div className="mt-2 flex flex-col">
          ...
          {errors.terms && (
            <p className="mt-2 text-sm text-abeg-teal">{errors.terms.message}</p>
          )}
        </div>
