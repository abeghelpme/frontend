...
const SignUp = () => {
	...
	return (
		<>
			<NextSeo
				canonical="https://www.abeghelp.me/signup"
				openGraph={{
					url: "https://www.abeghelp.me/signup",
					title: "Sign up with Abeg Help",
					description: "Create an account to start crowdfunding with ease",
					images: [
						{
