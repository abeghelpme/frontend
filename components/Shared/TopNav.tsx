...
export default function TopNav({ toggleSidebar }: TopNavProps) {
	return (
		<div className="sticky top-0 flex items-center justify-between border-b border-gray-400 p-7  md:border-gray-300 md:p-4 md:pr-10">
			...
			<div className="flex items-center md:space-x-3">
				...
				<div className="relative mr-1 md:mr-0">
					<div className="absolute left-0 top-3 hidden h-5 border-l border-gray-400 md:block"></div>
					<div className="cursor-pointer md:m-2">
						<NotificationIcon />
					</div>
					<div className="absolute right-0 top-3 hidden h-5 border-r border-gray-400 md:block"></div>
				</div>
