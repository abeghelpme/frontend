...
const FirstStep = ({ setStep, recoveryCode }: AuthenticatorFirstStepProps) => {
	...
	const handleOtpSubmit = async () => {
		...
		if (dataInfo) {
			localStorage.setItem(`skip-2FA-${(user as User)?._id}`, JSON.stringify(true));
			setStep(2);
					...
					<div className="mx-auto flex w-full justify-end">
						...
						>
							<OtpInputDisplay
								otp={otp}
								setOtp={setOtp}
								topSection={<p>Enter the 6-digit code generated by your authentication app.</p>}
								bottomSection={
				...
				<div className="mx-auto mt-8 w-full lg:mt-10">
					...
					<ol className="mt-6 flex list-inside list-none flex-col gap-3">
						<li className="flex flex-col gap-2">
							...
							<p>
								We recommend downloading Google Authenticator app if you don&apos;t have one installed
								yet.
							</p>
						</li>
						<li className="flex flex-col gap-2">
								...
								{isQRCodeLoading ? (
									...
									<div className="flex w-full flex-col items-center justify-around gap-y-2 lg:flex-row">
										<div className="relative">
											<Image src={data?.data?.qrCode as string} height={250} width={250} alt="" />
										</div>
						...
						<li className="flex flex-col gap-4">
							...
							<p>
								After the QR code has been scanned or the key has been entered, your authentication
								app will generate a 6-digit code. Copy the code and click on the Next button to enter
								it.
							</p>
						</li>
					</ol>
