...
import type { Image } from "@/interfaces/Campaign";
import { cn } from "@/lib";
...
type DragAndDropProps = {
	value: Array<File | Image["secureUrl"]>;
	onChange: (files: Array<File | Image["secureUrl"]>) => void;
};
...
const DragAndDrop = (props: DragAndDropProps) => {
	...
	const handleImageUpload = (
		...
		toast.success("Success", {
			description: `Uploaded ${1} file successfully!`,
		});
	};
