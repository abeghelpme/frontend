...
const Button = (
	{ className, children, fullWidth, variant, size, disabled, ...props }: ButtonProps,
	...
	return (
		<button
			className={cn("px-5 py-2 rounded-lg text-white text-sm font-medium", buttonClass, className)}
			ref={ref}
			{...props}
		>
			{children}
