		...
		<div className="flex max-w-[467px] flex-col items-center text-sm md:text-base mx-auto">
			<div className="text-center space-y-8">
				...
				<OTPInput
					...
					inputStyle="!w-[15%] !text-base aspect-square border-[0.25px] border-otpBorder focus:border-abeg-primary focus:border rounded-[3px] shadow-otpInput outline-abeg-primary"
					inputType="number"
